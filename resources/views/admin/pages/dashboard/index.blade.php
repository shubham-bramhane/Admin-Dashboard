                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Recent Login <span>| Today</span></h5>
                    ...
                    @if (auth()->user()->hasRole('Super Admin') )
                     ...
                     <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Recent Logout <span>| Today</span></h5>
                            ...
                            @forelse (getActivities() as $activity)
                                <div class="activity-item d-flex">
                                    <div class="activite-label">
                                        {{-- like 4 weeks dont want ago --}}
                                        {{ $activity->created_at->diffForHumans() }}
                                    </div>
                                    <i class='bi bi-circle-fill activity-badge {{ textClass() }} align-self-start'></i>
